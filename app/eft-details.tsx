        ...
        >
          ...
          >
            ...
            <Text style={[styles.noteText, { color: colors.textSecondary }]}>
              Please use your name as the payment reference so we can
              acknowledge your contribution. Contact us at{" "}
              {DONATION_CONFIG.contactEmail} if you need assistance.
            </Text>
          </View>
