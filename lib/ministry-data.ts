...
export const EVENTS = [
  {
    ...
    image: require('@/assets/new/sunday-service-poster.jpeg'),
    description: "Join us for Sunday service featuring powerful preaching, worship, and ministry sessions.",
  ...
  },
  {
    ...
    image: require('@/assets/new/church youth.jpeg'),
    description: "Youth gathering with dynamic worship, relevant teaching, and fellowship.",
    registrationRequired: true,
    maxAttendees: 200,
  ...
  },
  {
    ...
    ticketTypes: ["Free Entry"],
    attendanceTypes: ["In-Person", "Online"],
    image: require('@/assets/new/ordination of ministers.jpeg'),
    description: "Special ordination service for ministers.",
    registrationRequired: true,
    maxAttendees: 300,
    currentAttendees: 42
  },
  {
    ...
    ticketTypes: ["Free Entry"],
    attendanceTypes: ["In-Person", "Online"],
    image: require('@/assets/new/worship team.jpeg'),
    description: "Worship service with our ministry team.",
